...
const PropertyTwo = ({ style }: any) => {
   ...
   return (
      <div className="property-listing-four bg-pink-three position-relative z-1 overflow-hidden pt-120 xl-pt-80 pb-110 xl-pb-60 mt-0 xl-mt-0 lg-mt-0">
         <div className="container container-large">
            <div className="position-relative z-1">
               ...
               <div className="section-btn text-center">
                  <Link href="/listing_01" className="btn-eleven fst-italic"><span>See all properties</span></Link>
               </div>
