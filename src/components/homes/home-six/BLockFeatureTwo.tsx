...
const BLockFeatureTwo = () => {
   ...
   return (
      <>
         <div className="block-feature-two mt-150 xl-mt-110 mb-150">
                  ...
                  <div className="col-xxl-7 col-md-6 d-flex wow fadeInLeft">
                     <div className="block-one w-100 h-100">
                        <div className="position-relative z-1 h-100">
                           <h3 className="mb-55 block-title">Secure your family&apos;s dream home.</h3>
                  ...
                  <div className="col-xxl-5 col-md-6 wow fadeInRight">
                     <div className="block-two">
                        <div className="bg-wrapper">
                           <h4>Who we are?</h4>
                           <p className="fs-22 mt-20">Your premier partner in real estate. <br /> Transforming properties into dreams. Let us guide your property with expertise.</p>
